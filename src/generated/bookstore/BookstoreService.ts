...
import type { Person as _bookstore_Person, Person__Output as _bookstore_Person__Output } from '../bookstore/Person';
...
export interface BookstoreServiceClient extends grpc.Client {
  ...
  LogBook(argument: _bookstore_Book, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_bookstore_Book__Output>): grpc.ClientUnaryCall;
  LogBook(argument: _bookstore_Book, metadata: grpc.Metadata, callback: grpc.requestCallback<_bookstore_Book__Output>): grpc.ClientUnaryCall;
  LogBook(argument: _bookstore_Book, options: grpc.CallOptions, callback: grpc.requestCallback<_bookstore_Book__Output>): grpc.ClientUnaryCall;
  LogBook(argument: _bookstore_Book, callback: grpc.requestCallback<_bookstore_Book__Output>): grpc.ClientUnaryCall;
  logBook(argument: _bookstore_Book, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_bookstore_Book__Output>): grpc.ClientUnaryCall;
  logBook(argument: _bookstore_Book, metadata: grpc.Metadata, callback: grpc.requestCallback<_bookstore_Book__Output>): grpc.ClientUnaryCall;
  logBook(argument: _bookstore_Book, options: grpc.CallOptions, callback: grpc.requestCallback<_bookstore_Book__Output>): grpc.ClientUnaryCall;
  logBook(argument: _bookstore_Book, callback: grpc.requestCallback<_bookstore_Book__Output>): grpc.ClientUnaryCall;
  
  LogPerson(argument: _bookstore_Person, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_bookstore_Person__Output>): grpc.ClientUnaryCall;
  LogPerson(argument: _bookstore_Person, metadata: grpc.Metadata, callback: grpc.requestCallback<_bookstore_Person__Output>): grpc.ClientUnaryCall;
  LogPerson(argument: _bookstore_Person, options: grpc.CallOptions, callback: grpc.requestCallback<_bookstore_Person__Output>): grpc.ClientUnaryCall;
  LogPerson(argument: _bookstore_Person, callback: grpc.requestCallback<_bookstore_Person__Output>): grpc.ClientUnaryCall;
  logPerson(argument: _bookstore_Person, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_bookstore_Person__Output>): grpc.ClientUnaryCall;
  logPerson(argument: _bookstore_Person, metadata: grpc.Metadata, callback: grpc.requestCallback<_bookstore_Person__Output>): grpc.ClientUnaryCall;
  logPerson(argument: _bookstore_Person, options: grpc.CallOptions, callback: grpc.requestCallback<_bookstore_Person__Output>): grpc.ClientUnaryCall;
  logPerson(argument: _bookstore_Person, callback: grpc.requestCallback<_bookstore_Person__Output>): grpc.ClientUnaryCall;
...
export interface BookstoreServiceHandlers extends grpc.UntypedServiceImplementation {
  ...
  LogBook: grpc.handleUnaryCall<_bookstore_Book__Output, _bookstore_Book>;
  
  LogPerson: grpc.handleUnaryCall<_bookstore_Person__Output, _bookstore_Person>;
...
export interface BookstoreServiceDefinition extends grpc.ServiceDefinition {
  ...
  LogBook: MethodDefinition<_bookstore_Book, _bookstore_Book, _bookstore_Book__Output, _bookstore_Book__Output>
  LogPerson: MethodDefinition<_bookstore_Person, _bookstore_Person, _bookstore_Person__Output, _bookstore_Person__Output>
